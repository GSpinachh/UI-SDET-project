...
from Pages.SortClients.sort_clients_locators import SortClientLocators
from Pages.customer_management import customers, first_name
...
class SortClients(BasePage):
    ...
    @allure.step(f'Сравнить оригинальный список имен с отсортированным')
